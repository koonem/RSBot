...
import org.harrynoob.scripts.drsfighter.node.ability.AbilityUser;
import org.harrynoob.scripts.drsfighter.node.ability.RejuvenateSwitcher;
import org.harrynoob.scripts.drsfighter.node.ability.RejuvenateUser;
import org.harrynoob.scripts.drsfighter.node.ability.ThresholdUser;
import org.harrynoob.scripts.drsfighter.node.ability.UltimateUser;
...
@Manifest(name = "DRSFighter", topic = 899074, version = 1.21, authors = "harrynoob", description = "Kills deadly red spiders. Supports weapon switching & charm looting & effigies & spintickets!", website = "http://www.powerbot.org/community/topic/882944-eoc-drsfighter-kills-deadly-red-spiders-great-xp/")
			...
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					try {
						...
						main.setTitle("DRSFighter v1.21");
						main.pack();
