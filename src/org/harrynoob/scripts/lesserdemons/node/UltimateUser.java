...
public class UltimateUser extends Node {
	...
	public boolean activate() {
		return Percentages.getHealthPercent(Players.getLocal().get()) >70
				...
				&& Players.getLocal().getInteracting().equals(LDFighter.instance.getCurrentTarget())
				&& Actionbar.getAdrenalinPercent() == 100
				&& Percentages.getHealthPercent(LDFighter.instance.getCurrentTarget().get()) > 33
	...
	public void execute() {
		...
		for(Actionbar.Ability a : ultimates)
		{
			...
			{
				LDFighter.instance.status = "Using ultimates";
